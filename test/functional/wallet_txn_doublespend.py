...
class TxnMallTest(BluecoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 BLU:
        ...
        # First: use raw transaction API to send 1240 BLU to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 BLU coin each
        ...
        # Node0's balance should be starting balance, plus 50BLU for another
        ...
        # Node0's total balance should be starting balance, plus 100BLU for
