...
class NetTest(BluecoinTestFramework):
    ...
    def test_getnodeaddresses(self):
        ...
        self.nodes[0].addpeeraddress(address=ipv6_addr, port=19634)
        ...
        for i in range(10000):
            ...
            self.nodes[0].addpeeraddress(a, 19634)
    ...
    def test_addpeeraddress(self):
        ...
        assert_equal(node.addpeeraddress(address="", port=19634), {"success": False})
