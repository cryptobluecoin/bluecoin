...
class ConfArgsTest(BluecoinTestFramework):
    ...
    def test_config_file_parser(self):
        ...
        # Check that startup fails if conf= is set in bluecoin.conf or in an included conf file
        bad_conf_file_path = os.path.join(self.options.tmpdir, 'node0', 'bluecoin_bad.conf')
        ...
        main_conf_file_path = os.path.join(self.options.tmpdir, 'node0', 'bluecoin_main.conf')
    ...
    def run_test(self):
        ...
        none_existent_conf_file = os.path.join(default_data_dir, "none_existent_bluecoin.conf")
