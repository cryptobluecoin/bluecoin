...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the BluecoinTestFramework
    pass


class ExampleTest(BluecoinTestFramework):
    # Each functional test is a subclass of the BluecoinTestFramework class.
    ...
    def custom_method(self):
        ...
        BluecoinTestFramework class so other tests can use it."""
