...
"""
Test starting bluecoind with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(BluecoinTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that bluecoind has bound on "::1" (for RPC) and "::" (for P2P).
