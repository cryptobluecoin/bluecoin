...
# TestP2PConn: A peer we use to send messages to bluecoind, and store responses.
...
class CompactBlocksTest(BluecoinTestFramework):
    ...
    # This test actually causes bluecoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that bluecoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for bluecoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        node = self.nodes[0]
        # bluecoind will not send blocktxn responses for blocks whose height is
