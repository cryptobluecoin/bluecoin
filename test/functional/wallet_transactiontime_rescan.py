...
class TransactionTimeRescanTest(BluecoinTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine BLU and create transactions
        ...
        # generate some blu to create transactions and check blockcount
        ...
        # send 10 blu to user's first watch-only address
        self.log.info('Send 10 blu to user')
        ...
        # send 5 blu to our second watch-only address
        self.log.info('Send 5 blu to user')
        ...
        # send 1 blu to our third watch-only address
        self.log.info('Send 1 blu to user')
