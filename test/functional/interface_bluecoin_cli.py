...
# The block reward of coinbaseoutput.nValue (50) BLU/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 BLU/block.
...
class TestBluecoinCli(BluecoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Test -getinfo and bluecoin-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and bluecoin-cli getwalletinfo return expected wallet info")
            ...
            # Mine a block to confirm; adds a block reward (50 BLU) to the default wallet.
            ...
            # Test bluecoin-cli -generate with -rpcwallet in multiwallet mode.
