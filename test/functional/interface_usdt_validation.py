...
""" Tests the validation:* tracepoint API interface.
    See https://github.com/bluecoin/bluecoin/blob/master/doc/tracing.md#context-validation
"""
...
class ValidationTracepointTest(BluecoinTestFramework):
    ...
    def run_test(self):
        ...
        # blocks.
        # See https://github.com/bluecoin/bluecoin/blob/master/doc/tracing.md#tracepoint-validationblock_connected
