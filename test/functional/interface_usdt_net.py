...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/bluecoin/bluecoin/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(BluecoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our bluecoind node")
