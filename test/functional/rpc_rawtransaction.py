...
class RawTransactionsTest(BluecoinTestFramework):
    ...
    def sendrawtransaction_testmempoolaccept_tests(self):
        ...
        # Fee rate is 0.00100000 BLU/kvB
        ...
        # Fee rate is 0.20000000 BLU/kvB
    ...
    def decoderawtransaction_tests(self):
        ...
        assert_equal(decrawtx['vout'][0]['value'], Decimal('1.00000000'))
        # known ambiguous transaction in the chain (see https://github.com/bluecoin/bluecoin/issues/20579)
