...
Verify that a bluecoind node can use an external signer command.
...
class RPCSignerTest(BluecoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart bluecoind with -signer=<cmd>',
