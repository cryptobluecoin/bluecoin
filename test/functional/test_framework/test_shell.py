...
class TestShell:
    """Wrapper Class for BluecoinTestFramework.

    The TestShell class extends the BluecoinTestFramework
    ...
    class __TestShell(BluecoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by BluecoinTestFramework child class.
            self.num_nodes = 1
