...
interfaces.
- [util](/test/util) which tests the utilities (bluecoin-util, bluecoin-tx, ...).
...
Before tests can be run locally, Bluecoin Core must be built.  See the [building instructions](/doc#building) for help.
