...
This guide describes how to build bluecoind, command-line utilities, and GUI on OpenBSD.
...
...
to: /path/to/bluecoin/depends/x86_64-unknown-openbsd
```

Then set `BDB_PREFIX`:

```bash
export BDB_PREFIX="/path/to/bluecoin/depends/x86_64-unknown-openbsd"
```

#### GUI Dependencies
###### Qt5

Bluecoin Core includes a GUI built with the cross-platform Qt Framework. To compile the GUI, Qt 5 is required.
...
(see issue [#6658](https://github.com/bluecoin/bluecoin/issues/6658)).
