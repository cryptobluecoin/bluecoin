...
The ZeroMQ feature in Bluecoin Core requires the ZeroMQ API >= 4.0.0
...
For instance:
    ...
    $ bluecoind -zmqpubhashtx=tcp://127.0.0.1:219633 \
               -zmqpubhashtx=tcp://192.168.1.2:219633 \
               -zmqpubhashblock="tcp://[::1]:219634" \
...
terminator). These options can also be provided in bluecoin.conf.
