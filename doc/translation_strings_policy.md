...
This document provides guidelines for internationalization of the Bluecoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bluecoin_en.ts` remains unchanged.
