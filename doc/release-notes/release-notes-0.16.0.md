Bluecoin Core version 0.16.0 is now available from:
  ...
  <https://bitcoincore.org/bin/bluecoin-core-0.16.0/>
...
GUI changes
-----------
- Uses of "µBLU" in the GUI now also show the more colloquial term "bits", specified in BIP176.
...
Testing changes
----------------
- The default regtest JSON-RPC port has been changed to 18443 to avoid conflict with testnet's default of 29633.
...
- #11917 `bc66765` Add testnet DNS seed:  seed.testnet.bluecoin.sprovoost.nl (Sjors)
...
- #11970 `b7450cd` Add test coverage for bluecoin-cli multiwallet calls (ryanofsky)
...
- #10997 `affe927` Add option -stdinrpcpass to bluecoin-cli to allow RPC password to be read from standard input (jharvell)
...
- #10825 `28485c7` Set regtest JSON-RPC port to 18443 to avoid conflict with testnet 29633 (fametrano)
...
- #12035 `eeb6d52` Change µBLU to bits (jb55)
...
- #11621 `1f7695b` [build] Add temp_bluecoin_locale_qrc to CLEAN_QT to fix make distcheck (fanquake)
...
- #11711 `6378e5c` bluecoin_qt.m4: Minor fixes and clean-ups (fanquake)
...
- #11297 `16e4184` Make sure ~/.bluecoin doesn't exist before build (MeshCollider)
...
- #11143 `3aa60b7` Fix include path for bluecoin-config.h (danra)
...
- #10871 `c9a4aa8` Handle getinfo in bluecoin-cli w/ -getinfo (revival of #8843) (achow101)
- #11419 `093074b` Utils: Fix launchctl not being able to stop bluecoind (OmeGak)
...
- #10529 `331352f` Improve bluecoind systemd service file (Flowdalic)
