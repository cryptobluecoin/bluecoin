Bluecoin Core version 0.9.2.1 is now available from:

  https://bluecoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 BLU to 0.01 BLU
...
- Fix "Start bluecoin on system login"
