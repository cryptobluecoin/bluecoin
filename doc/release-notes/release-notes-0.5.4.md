Bluecoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bluecoin/files/Bluecoin/bluecoin-0.5.4/
...
http://gitorious.org/bluecoin/bluecoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Bluecoin-Qt notifications under Growl 1.3.
Increase required age of Bluecoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBluecoin properly when installing Bluecoin-Qt over it. (Windows)
