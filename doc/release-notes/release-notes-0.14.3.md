Bluecoin Core version *0.14.3* is now available from:

  <https://bluecoin.org/bin/bluecoin-core-0.14.3/>
...
- #10451 `3612219` contrib/init/bluecoind.openrcconf: Don't disable wallet by default (Luke Dashjr)
