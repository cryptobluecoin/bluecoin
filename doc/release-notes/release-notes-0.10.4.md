Bluecoin Core version 0.10.4 is now available from:

  <https://bluecoin.org/bin/bluecoin-core-0.10.4/>
...
- #6953 `43c2789` Split bluecoin-tx into its own package
- #6953 `dfe0d4d` Include bluecoin-tx binary on Debian/Ubuntu
