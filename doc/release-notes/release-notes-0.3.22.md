Download URL: https://sourceforge.net/projects/bluecoin/files/Bluecoin/bluecoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 BLU fee schedule (users still pay 0.01 BLU per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #bluecoin00 - #bluecoin99
