Bluecoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/bluecoin/files/Bluecoin/bluecoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Bluecoin
...
New/changed settings (command-line or bluecoin.conf file)
--------------------------------------------------------
