Bluecoin Core version 0.13.2 is now available from:
  ...
  <https://bluecoin.org/bin/bluecoin-core-0.13.2/>
...
- #8908 `4a974b2` Update bluecoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow bluecoin-tx to create v2 transactions (bludrak)
