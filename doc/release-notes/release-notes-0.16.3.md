Bluecoin Core version 0.16.3 is now available from:
  ...
  <https://bitcoincore.org/bin/bluecoin-core-0.16.3/>
...
been discovered in Bluecoin Core versions 0.14.0 up to 0.16.2. It is recommended
...
### Miscellaneous
- #13655 `1cdbea7` bluecoinconsensus: invalid flags error should be set to `bluecoinconsensus_err` (afk11)
