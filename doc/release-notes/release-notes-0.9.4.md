Bluecoin Core version 0.9.4 is now available from:

  https://bluecoin.org/bin/0.9.4/
...
this update is incompatible with the Bluecoin system and could lead to consensus
forks.

Bluecoin Core released binaries from https://bluecoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bluecoin/+archive/ubuntu/bluecoin
- A third-party or self-compiled Bluecoin Core

upgrade to Bluecoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
