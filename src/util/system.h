 ...
 */
#ifndef BLUECOIN_UTIL_SYSTEM_H
#define BLUECOIN_UTIL_SYSTEM_H
...
extern const char * const BLUECOIN_CONF_FILENAME;
extern const char * const BLUECOIN_SETTINGS_FILENAME;
