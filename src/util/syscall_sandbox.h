...
#ifndef BLUECOIN_UTIL_SYSCALL_SANDBOX_H
#define BLUECOIN_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during bluecoind initialization if Bluecoin Core was compiled
...
#endif // BLUECOIN_UTIL_SYSCALL_SANDBOX_H
