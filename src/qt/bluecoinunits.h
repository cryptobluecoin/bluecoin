...
#ifndef BLUECOIN_QT_BLUECOINUNITS_H
#define BLUECOIN_QT_BLUECOINUNITS_H
...
*/
class BluecoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BluecoinUnits(QObject *parent);

    /** Bluecoin units.
      @note Source: https://en.bluecoin.it/wiki/Units . Please add only sensible ones
     */
    enum class Unit {
        BLU,
        mBLU,
