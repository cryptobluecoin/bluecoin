      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->bluecoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->bluecoinAtStartup);
    ...
    ui->bluecoinAtStartup->setToolTip(ui->bluecoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->bluecoinAtStartup->setText(ui->bluecoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openBluecoinConfButton->setToolTip(ui->openBluecoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new BluecoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->bluecoinAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSBLUontrols);
...
void OptionsDialog::on_openBluecoinConfButton_clicked()
{
