...
{
    // Test regression https://github.com/bluecoin/bluecoin/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/bluecoin-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/bluecoin-core/gui/pull/568.
    // With fListen=false in ~/.config/Bluecoin/Bluecoin-Qt.conf and all else left as default,
    // bluecoin-qt should set both -listen and -listenonion to false and start successfully.
