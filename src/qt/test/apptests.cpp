...
//! Entry point for BluecoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &BluecoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for BluecoinGUI tests.
void AppTests::guiTests(BluecoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &BluecoinGUI::consoleShown, this, &AppTests::consoleTests);
