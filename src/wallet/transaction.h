...
#ifndef BLUECOIN_WALLET_TRANSACTION_H
#define BLUECOIN_WALLET_TRANSACTION_H
...
public:
     ...
     * on this bluecoin node, and set to 0 for transactions that were created
...
#endif // BLUECOIN_WALLET_TRANSACTION_H
