...
#ifndef BLUECOIN_WALLET_SCRIPTPUBKEYMAN_H
#define BLUECOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Bluecoin Core wallet was originally a collection of unrelated private
...
#endif // BLUECOIN_WALLET_SCRIPTPUBKEYMAN_H
