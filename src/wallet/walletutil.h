...
#ifndef BLUECOIN_WALLET_WALLETUTIL_H
#define BLUECOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! bluecoin from opening the wallet, thinking it was newly created, and
...
#endif // BLUECOIN_WALLET_WALLETUTIL_H
