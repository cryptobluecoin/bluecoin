...
#ifndef BLUECOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define BLUECOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // BLUECOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
