...
#ifndef BLUECOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define BLUECOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@bluecoin.
 *
 ...
 *
 * The chacha20-poly1305@bluecoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@bluecoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@bluecoin are relatively fast in
...
#endif // BLUECOIN_CRYPTO_CHACHA_POLY_AEAD_H
