...
#ifndef BLUECOIN_NODE_CONNECTION_TYPES_H
#define BLUECOIN_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/bluecoin-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Bluecoin’s Peer-to-Peer Network")
...
#endif // BLUECOIN_NODE_CONNECTION_TYPES_H
