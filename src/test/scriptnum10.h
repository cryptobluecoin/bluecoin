...
#ifndef BLUECOIN_TEST_SCRIPTNUM10_H
#define BLUECOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Bluecoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // BLUECOIN_TEST_SCRIPTNUM10_H
