...
{
    BOOST_CHECK(TestSplitHost("www.bluecoincore.org", "www.bluecoincore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.bluecoincore.org]", "www.bluecoincore.org", 0));
    BOOST_CHECK(TestSplitHost("www.bluecoincore.org:80", "www.bluecoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.bluecoincore.org]:80", "www.bluecoincore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("127.0.0.1:19634", "127.0.0.1", 19634));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:19634", "127.0.0.1", 19634));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:19634", "::ffff:127.0.0.1", 19634));
    BOOST_CHECK(TestSplitHost("[::]:19634", "::", 19634));
    BOOST_CHECK(TestSplitHost("::19634", "::19634", 0));
    BOOST_CHECK(TestSplitHost(":19634", "", 19634));
    BOOST_CHECK(TestSplitHost("[]:19634", "", 19634));
    ...
    BOOST_CHECK(TestSplitHost("www.bluecoincore.org:65536", "www.bluecoincore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.bluecoincore.org:0", "www.bluecoincore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.bluecoincore.org:", "www.bluecoincore.org:", 0, false));
}
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:19634", "127.0.0.1:19634"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:19634", "[::]:19634"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
