...
#ifndef BLUECOIN_SCRIPT_STANDARD_H
#define BLUECOIN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a bluecoin address
 */
...
/**
 * Generate a Bluecoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // BLUECOIN_SCRIPT_STANDARD_H
