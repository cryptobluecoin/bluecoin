...
#ifndef BLUECOIN_ARITH_UINT256_H
#define BLUECOIN_ARITH_UINT256_H
...
public:
     ...
     *
     * Bluecoin only uses this "compact" format for encoding difficulty
...
#endif // BLUECOIN_ARITH_UINT256_H
