...
#ifndef BLUECOIN_INTERFACES_INIT_H
#define BLUECOIN_INTERFACES_INIT_H
...
//! (bluecoin-gui, bluecoin-node, bluecoin-wallet, bluecoind, bluecoin-qt) and each
...
#endif // BLUECOIN_INTERFACES_INIT_H
