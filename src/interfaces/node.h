...
#ifndef BLUECOIN_INTERFACES_NODE_H
#define BLUECOIN_INTERFACES_NODE_H
...
//! Top-level interface for a bluecoin node (bluecoind process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or bluecoin.conf.
...
#endif // BLUECOIN_INTERFACES_NODE_H
