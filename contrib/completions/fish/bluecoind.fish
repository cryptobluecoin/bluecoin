...
complete --command bluecoind --no-files

# Extract options
function __fish_bluecoind_get_options
...
complete \
    --command bluecoind \
    --arguments "(__fish_bluecoind_get_options --nofiles)"
