...
# Extract options
function __fish_bluecoin_tx_get_options
...
# Extract commands
function __fish_bluecoin_tx_get_commands
...
complete \
    --command bluecoin-tx \
    --condition "not __fish_bluecoin_seen_cmd (__fish_bluecoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_bluecoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command bluecoin-tx \
    --arguments "(__fish_bluecoin_tx_get_commands)" \
    --no-files
