...
complete --command bluecoin-qt --no-files

# Extract options
function __fish_bluecoinqt_get_options
...
complete \
    --command bluecoin-qt \
    --arguments "(__fish_bluecoinqt_get_options --nofiles)"
