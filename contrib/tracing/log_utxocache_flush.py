...
"""Example logging Bluecoin Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/bluecoind
...
def main(bluecoind_path):
    ...
    b = BPF(text=program, usdt_contexts=[bluecoind_with_usdts])
